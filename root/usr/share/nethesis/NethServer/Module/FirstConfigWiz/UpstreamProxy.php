 ...
 */
class UpstreamProxy extends \Nethgui\Controller\AbstractController {

    public $wizardPosition = 70;

    protected function initializeAttributes(\Nethgui\Module\ModuleAttributesInterface $attributes) {
        return new \NethServer\Tool\CustomModuleAttributesProvider($attributes, array('languageCatalog' => 'NethServer_Module_NetworkAdapter_UpstreamProxy'));
    }
    ...
    protected function onParametersSaved($changes)
    {
        $this->getParent()->storeAction(array(
            'message' => array(
                ...
                'id' => 'UpstreamProxy_Action',
                'args' => $this->parameters->getArrayCopy()
            ),
            'events' => array('proxy-update')
        ));
    }
