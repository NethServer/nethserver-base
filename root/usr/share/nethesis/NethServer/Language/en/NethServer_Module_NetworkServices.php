...
$L['access_private_label'] = 'Access only from local networks (private)';
$L['access_public_label'] = 'Access from all networks (public)';
$L['access_none_label'] = 'Access only from localhost (none)';
