...
$L['GenerateLe_Header'] = 'Create a Letsencrypt certificate';
$L['Generate_Header'] = 'Create self signed CA certificate';
$L['Upload_Header'] = 'Upload certificate to the server';
