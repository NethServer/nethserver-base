...
Viene mostrata la relativa lista di pacchetti opzionali, selezionarli
per l'installazione.

.. note:: 

    Per installare un pacchetto opzionale *DOPO* l'installazione del
    componente relativo, cliccare sul bottone :guilabel:`Continua` e
    selezionare il pacchetto opzionale.
